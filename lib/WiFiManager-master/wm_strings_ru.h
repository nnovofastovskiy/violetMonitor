...
const char HTTP_ROOT_MAIN[] PROGMEM = "<h1 class='title'>{t}</h1><h3>Настройки</h3>";

const char *const HTTP_PORTAL_MENU[] PROGMEM = {
	"<form action='/wifi'    method='get'><button>Настроить WiFi</button></form><br/>\n",			// MENU_WIFI
	"<form action='/0wifi'   method='get'><button>Настроить WiFi (No scan)</button></form><br/>\n", // MENU_WIFINOSCAN
	"<form action='/info'    method='get'><button>Информация</button></form><br/>\n",				// MENU_INFO
	"<form action='/param'   method='get'><button>Параметры</button></form><br/>\n",				// MENU_PARAM
	...
	"<form action='/erase'   method='get'><button class='D'>Сброс</button></form><br/>\n",			// MENU_ERASE
...
const char HTTP_SCAN_LINK[] PROGMEM = "<br/><form action='/wifi?refresh=1' method='POST'><button name='refresh' value='1'>Поиск сетей</button></form>";
const char HTTP_SAVED[] PROGMEM = "<div class='msg'>Сохранение настроек WI-FI";
const char HTTP_PARAMSAVED[] PROGMEM = "<div class='msg S'>Настройки сохранены<br/></div>";
...
const char HTTP_STATUS_ON[] PROGMEM = "<div class='msg S'><strong>Поключено</strong> к {v}<br/><em><small>with IP {i}</small></em></div>";
...
const char HTTP_STATUS_NONE[] PROGMEM = "<div class='msg'>Настройки подключения отсутствуют</div>";
...
const char HTTP_INFO_aboutver[] PROGMEM = "<dt>Настройки</dt><dd>{1}</dd>";
...
const char S_titlewifisaved[] PROGMEM = "Настройки WI-FI сохранены";
const char S_titlewifisettings[] PROGMEM = "Настройки WI-FI сохранены";
